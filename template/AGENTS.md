# {Brand_Name} - Agent Skills Repository
## AGENTS.md (Symlink to CLAUDE.md)

This repo contains {Brand_Name} Agent Skills — folders of instructions, references, scripts, and assets that AI agents use to work more accurately. For detailed architecture, see [ARCHITECTURE.md](ARCHITECTURE.md).
