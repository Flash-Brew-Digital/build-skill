# Contributing to the Build Skill CLI
...
2. Clone your fork locally:
   ...
   ```bash
   git clone https://github.com/your-username/build-skill.git
   cd build-skill
   ```
...
1. **Clear conventional title**: Describe what changed (e.g., `feat: add skill utility`)
